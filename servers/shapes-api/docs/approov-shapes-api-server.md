...
```bash
git clone https://github.com/approov/quickstart-java-spring_shapes-api.git
cd quickstart-java-spring_shapes-api
```
...
./stack shell
```
> All subsequent shell commands must be executed from this shell terminal.
...
Open Postman and import [this collection](https://raw.githubusercontent.com/approov/postman-collections/master/quickstarts/shapes-api/shapes-api.postman_collection.json)
